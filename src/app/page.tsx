    ...
    <div className="min-h-screen bg-black text-white selection:bg-emerald-500/30 overflow-x-hidden">
      ...
      <section className="relative py-24 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="relative glass border border-white/10 rounded-[4rem] p-12 md:p-20 overflow-hidden group">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                >
                  Crops <span className="text-emerald-500 italic">Exchange</span><br />
                  <span className="text-zinc-500 text-3xl md:text-5xl">Potato Commencement</span>
                </motion.h2>
                ...
                <motion.p 
                  ...
                  className="text-zinc-400 text-lg font-medium max-w-lg mb-10"
                >
                ...
                >
                  <div className="flex flex-col">
                    <span className="text-[10px] font-black uppercase tracking-widest text-zinc-500 mb-1">Commencement Time</span>
                    <span className="text-xl font-bold text-white font-mono">02/04/2026 @ 21:30</span>
                  </div>
                  
                  <button className="rounded-2xl bg-white text-black px-8 py-4 text-lg font-black uppercase tracking-tighter hover:bg-emerald-500 hover:text-white transition-all transform active:scale-95 shadow-xl shadow-white/5">
                    Register for Seat
                  </button>
                </motion.div>
              </div>
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                className="relative aspect-square lg:aspect-auto lg:h-[400px] flex items-center justify-center"
              >
                <div className="absolute inset-0 bg-emerald-500/20 blur-[100px] rounded-full animate-pulse" />
                <div className="relative w-72 h-72 md:w-96 md:h-96 glass-dark rounded-[3rem] border border-white/10 flex items-center justify-center p-12 overflow-hidden shadow-2xl skew-x-3 hover:skew-x-0 transition-transform duration-700">
                   <Leaf className="h-48 w-48 text-emerald-500 opacity-20 absolute -bottom-10 -right-10 rotate-12" />
                   <div className="text-center">
                     <span className="text-8xl mb-4 block">🥔</span>
                     <div className="text-[10px] font-black uppercase tracking-[0.5em] text-emerald-500/50">SECURED_VAULT_001</div>
                   </div>
                </div>
              </motion.div>
            </div>
